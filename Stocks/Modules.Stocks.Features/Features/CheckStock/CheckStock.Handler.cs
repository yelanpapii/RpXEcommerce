    ...
    : ICheckStockHandler
{
    ...
    private static IEnumerable<Error> VerifyProductQuantities(List<ProductStockDto> products, Dictionary<string, int> stocks)
    {
    ...
    private async Task<Dictionary<string, int>> GetProductStocksAsync(List<ProductStockDto> products, CancellationToken cancellationToken)
    {
