    ...
    : ICreateStockHandler
{
    ...
    private static Domain.Entities.ProductStock CreateProductStock(CreateStockRequest request)
        => new()
        {
            Id = Guid.NewGuid(),
    ...
    private static CreateStockResponse MapToCreateStockResponse(Domain.Entities.ProductStock stock)
